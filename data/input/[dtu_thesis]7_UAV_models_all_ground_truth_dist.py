...
X = np.load('/Users/marton/DTU_MSC/IV_SEMESTER/Thesis/data/5GHz_7UAV/X_ground_truth_dist_data.npy')
y = np.load('/Users/marton/DTU_MSC/IV_SEMESTER/Thesis/data/5GHz_7UAV/y_ground_truth_dist_data.npy')
...
joblib.dump(scaler_X, '/Users/marton/DTU_MSC/IV_SEMESTER/Thesis/data/5GHz_7UAV/X_ground_truth_dist_scaler.joblib')
joblib.dump(scaler_y, '/Users/marton/DTU_MSC/IV_SEMESTER/Thesis/data/5GHz_7UAV/y_ground_truth_dist_scaler.joblib')
...
def add_noise(X, noise_level=0.0):
    # X shape: (num_samples, 33), cols 0-11: anchor positions, 12-32: distances
...
for noise_level in noise_levels:
    ...
    np.save(f'/Users/marton/DTU_MSC/IV_SEMESTER/Thesis/data/5GHz_7UAV/ground_truth_dist_DNN_y_pred_noise_{noise_level}.npy', y_pred_dnn)
    np.save(f'/Users/marton/DTU_MSC/IV_SEMESTER/Thesis/data/5GHz_7UAV/ground_truth_dist_DNN_y_test_noise_{noise_level}.npy', y_test)
    ...
    np.save(f'/Users/marton/DTU_MSC/IV_SEMESTER/Thesis/data/5GHz_7UAV/ground_truth_dist_RFR_y_pred_noise_{noise_level}.npy', y_pred_rfr)
    np.save(f'/Users/marton/DTU_MSC/IV_SEMESTER/Thesis/data/5GHz_7UAV/ground_truth_dist_RFR_y_test_noise_{noise_level}.npy', y_test)
...
# Save DataFrame
results_df.to_csv('/Users/marton/DTU_MSC/IV_SEMESTER/Thesis/data/5GHz_7UAV/ground_truth_dist_results.csv', index=False)


# In[12]:


def plot_dnn_rfr_results_7uav(results_df, save_dir='/Users/marton/DTU_MSC/IV_SEMESTER/Thesis/pictures/ML_methods/7UAV/dist'):
    # Set seaborn style
    sns.set_style("whitegrid")

    # Define color palette with distinct colors
    palette = sns.color_palette("tab10", n_colors=2)  # 2 colors for DNN and RFR
...
# Load DataFrame from 7UAV combined DNN/RFR run
results_df = pd.read_csv('/Users/marton/DTU_MSC/IV_SEMESTER/Thesis/data/5GHz_7UAV/ground_truth_dist_results.csv')
