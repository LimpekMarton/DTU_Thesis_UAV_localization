...
X = np.load('/Users/marton/DTU_MSC/IV_SEMESTER/Thesis/data/5GHz_7UAV/X_rss_aoa_data.npy')
y = np.load('/Users/marton/DTU_MSC/IV_SEMESTER/Thesis/data/5GHz_7UAV/y_rss_aoa_data.npy')
...
def add_noise(X, noise_level=0.0):
    # X shape: (num_samples, 117), cols 0-11: anchor positions, 12-32: path losses, 33-116: AoA
...
for noise_level in noise_levels:
    ...
    np.save(f'/Users/marton/DTU_MSC/IV_SEMESTER/Thesis/data/5GHz_7UAV/ground_truth_rss_aoa_DNN_y_pred_noise_{noise_level}.npy', y_pred_dnn)
    np.save(f'/Users/marton/DTU_MSC/IV_SEMESTER/Thesis/data/5GHz_7UAV/ground_truth_rss_aoa_DNN_y_test_noise_{noise_level}.npy', y_test)
    ...
    np.save(f'/Users/marton/DTU_MSC/IV_SEMESTER/Thesis/data/5GHz_7UAV/ground_truth_rss_aoa_RFR_y_pred_noise_{noise_level}.npy', y_pred_rfr)
    np.save(f'/Users/marton/DTU_MSC/IV_SEMESTER/Thesis/data/5GHz_7UAV/ground_truth_rss_aoa_RFR_y_test_noise_{noise_level}.npy', y_test)
...
# Save DataFrame
results_df.to_csv('/Users/marton/DTU_MSC/IV_SEMESTER/Thesis/data/5GHz_7UAV/ground_truth_rss_aoa_results.csv', index=False)


# In[9]:


def plot_dnn_rfr_results_7uav(results_df, save_dir='/Users/marton/DTU_MSC/IV_SEMESTER/Thesis/pictures/ML_methods/7UAV/path_loss_aoa'):
...
results_df = pd.read_csv('/Users/marton/DTU_MSC/IV_SEMESTER/Thesis/data/5GHz_7UAV/ground_truth_rss_aoa_results.csv')
